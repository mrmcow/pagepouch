...
💡 **Quick Tip**: That's literally all the setup you need. [Start now](/auth/signup) and capture your first source in 30 seconds.
...
**Don't:**
- ❌ Spend more than 30 seconds capturing
- ❌ Create sub-folders
- ❌ Use more than 2 tags per item
- ❌ Write long notes
- ❌ Organize "later" (organize now, quickly)
...
**Even then, keep it simple. More complexity ≠ better results.**
