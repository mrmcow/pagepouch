...
**❌ Mistake 1**: Saving everything without filtering
**✅ Solution**: Be selective. Ask "Will I actually use this?"

**❌ Mistake 2**: Complex folder hierarchies
**✅ Solution**: Keep folders simple, use tags for complexity

**❌ Mistake 3**: Not adding context when saving
**✅ Solution**: Always note why you saved it

**❌ Mistake 4**: Organizing later instead of now
**✅ Solution**: 30 seconds now beats 30 minutes later
...
✅ You can find any article in under 30 seconds
✅ You know exactly what you've read vs. need to read
✅ You can see connections between articles
✅ You rarely re-read articles because you have good notes
✅ Writing is faster because research is organized
