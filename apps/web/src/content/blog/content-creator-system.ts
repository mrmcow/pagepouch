...
**When creating**: Search "hooks" → instant inspiration.
...
**❌ Mistake 2**: No tags or organization
**✅ Solution**: 30 seconds to tag now beats 30 minutes searching later

**❌ Mistake 3**: Never reviewing saved content
**✅ Solution**: Weekly 15-minute review session

**❌ Mistake 4**: Copying instead of learning
**✅ Solution**: Save to learn principles, not to copy directly
