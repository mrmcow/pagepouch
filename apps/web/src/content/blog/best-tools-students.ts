...
✅ Page graphs for visualizing connections
✅ Offline access for studying anywhere

**Cons:**
❌ No mobile app yet (web works on mobile)
❌ Requires signup
...
✅ Great mobile apps
✅ Reading view removes distractions
✅ Offline reading

**Cons:**
❌ Limited organization (no folders)
❌ Basic search only
❌ Not built for research
...
**Pros:**
✅ Combines notes, tasks, wiki, and clipping
...
**❌ Mistake 1**: Choosing tool that's too complex
**✅ Solution**: Start simple, add features as needed

**❌ Mistake 2**: No organization from day one
**✅ Solution**: Set up folders before you clip

**❌ Mistake 3**: Saving without context
**✅ Solution**: Always add "why I saved this"

**❌ Mistake 4**: Not using mobile access
**✅ Solution**: Clip on phone between classes
