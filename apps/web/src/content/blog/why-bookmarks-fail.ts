...
✅ **Full content preserved** (survives deletion, changes, paywalls)
✅ **Full-text search** (find any word across all saved pages)
✅ **Automatic organization** (tags, folders, smart categorization)
✅ **Context capture** (notes, highlights, metadata)
✅ **Cross-device access** (web, mobile, desktop)
✅ **Offline reading** (access anywhere, anytime)
...
✅ Review new clips (add missing notes/tags)
