...
| **Survives Deletion** | ❌ No | ✅ Yes |
| **Works Offline** | ❌ No | ✅ Yes |
| **Searchable Text** | ❌ Limited | ✅ Full-text search |
| **Annotations** | ❌ No | ✅ Yes |
...
✅ **Full-page capture** with formatting preservation
✅ **Browser extension** for quick access
✅ **Full-text search** across all clips
✅ **Offline access** to saved content
✅ **Organization system** with folders and tags
✅ **Cross-device sync** for access anywhere
✅ **Annotations** for notes and highlights

### Advanced Features:

✅ **Page graphs** for visualizing connections
✅ **OCR** for searching images and PDFs
