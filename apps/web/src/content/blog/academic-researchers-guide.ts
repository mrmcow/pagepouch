...
export const academicResearchersGuide: BlogPost = {
  ...
  readingTime: 7,
  category: 'use-cases',
  tags: ['academic', 'research', 'literature-review', 'citations', 'papers'],
...
✅ **University databases**: Save full-text access
✅ **Note-taking apps**: Link to your notes
✅ **Writing tools**: Quick reference while drafting
...
2. Scan abstracts
3. Clip relevant papers
4. Add preliminary tags
5. Review and refine later
...
**❌ Mistake 1**: Saving everything without notes
**✅ Solution**: Add context when you clip

**❌ Mistake 2**: No organizational system
**✅ Solution**: Create folders and tags from day one

**❌ Mistake 3**: Not linking related papers
**✅ Solution**: Use page graphs to visualize connections

**❌ Mistake 4**: Waiting to organize
**✅ Solution**: 5 minutes daily beats 5 hours monthly
